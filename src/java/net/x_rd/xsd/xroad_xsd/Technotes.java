 ...
 */
    ...
    public static class Factory{
                ...
                public static Technotes fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    Technotes returnValue = new  Technotes();
                ...
                public static Technotes fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Technotes.Factory.fromString(content,namespaceUri);
                    } else {
                       return Technotes.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static Technotes parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Technotes object =
                new Technotes();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"technotes".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Technotes)net.x_rd.ee.municipality.producer.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

 ...
 */
    ...
    public static class Factory{
                ...
                public static Notes fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    Notes returnValue = new  Notes();
                ...
                public static Notes fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Notes.Factory.fromString(content,namespaceUri);
                    } else {
                       return Notes.Factory.fromString(content,"");
                    }
                }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"notes".equals(type)){
                                ...
                                return (Notes)net.x_rd.ee.municipality.producer.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

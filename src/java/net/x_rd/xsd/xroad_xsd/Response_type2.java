 ...
 */
            ...
            /**
            *  Response_type2 bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class Response_type2
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":response_type2",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "response_type2",
    ...
    public static class Factory{
        ...
        */
        public static Response_type2 parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            Response_type2 object =
                new Response_type2();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"response_type2".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (Response_type2)net.x_rd.ee.municipality.producer.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

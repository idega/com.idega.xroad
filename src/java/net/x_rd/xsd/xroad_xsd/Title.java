 ...
 */
    ...
    public static class Factory{
                ...
                public static Title fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    Title returnValue = new  Title();
                ...
                public static Title fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return Title.Factory.fromString(content,namespaceUri);
                    } else {
                       return Title.Factory.fromString(content,"");
                    }
                }
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"title".equals(type)){
                                ...
                                return (Title)net.x_rd.ee.municipality.producer.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }

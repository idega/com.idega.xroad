 ...
 */
                           ...
                           */
                           public  java.lang.String getFaultString(){
                            ...
                            public java.lang.String toString(){
                                        ...
                                        return localFaultString.toString();
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                ...
                //We can safely assume an element has only one type associated with it
                 return new org.apache.axis2.databinding.utils.reader.ADBXMLStreamReaderImpl(MY_QNAME,
                            ...
                            org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localFaultString)
                            },
                            null);
    ...
    public static class Factory{
                ...
                public static FaultString fromString(java.lang.String value,
                                                    java.lang.String namespaceURI){
                    FaultString returnValue = new  FaultString();
                    
                            returnValue.setFaultString(
                ...
                public static FaultString fromString(javax.xml.stream.XMLStreamReader xmlStreamReader,
                                                                    java.lang.String content) {
                    if (content.indexOf(":") > -1){
                        java.lang.String prefix = content.substring(0,content.indexOf(":"));
                        java.lang.String namespaceUri = xmlStreamReader.getNamespaceContext().getNamespaceURI(prefix);
                        return FaultString.Factory.fromString(content,namespaceUri);
                    } else {
                       return FaultString.Factory.fromString(content,"");
                    }
                }
        ...
        */
        public static FaultString parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FaultString object =
                new FaultString();

...
/**
 * SubmitParkingCardStatement.java
 *
 ...
 */
            ...
            /**
            *  SubmitParkingCardStatement bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class SubmitParkingCardStatement
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":submitParkingCardStatement",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "submitParkingCardStatement",
    ...
    public static class Factory{
        ...
        */
        public static SubmitParkingCardStatement parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            SubmitParkingCardStatement object =
                new SubmitParkingCardStatement();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"submitParkingCardStatement".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (SubmitParkingCardStatement)net.x_rd.ee.municipality.producer.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
